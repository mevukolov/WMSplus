...
comment on function public.assign_weeek_shift_task_assignees(text, date, boolean) is
  'Assigns uncompleted, unassigned WEEEK tasks due up to the shift date to incoming/outgoing shift responsibles. Blocks current-day assignment after 20:00 Moscow unless explicitly overridden.';
