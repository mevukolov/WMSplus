...
(
  ...
  null,
  true,
  'Контроль товара, зависшего на участках сортировки для других ЛО.',
  60
),
(
  'marketplace',
  ...
  null,
  false,
  'Срок постановки задач Маркетплейс внутри выгрузки Маркетплейс + ПЦ.',
  70
),
(
  'pc',
  ...
  null,
  false,
  'Срок постановки задач ПЦ внутри выгрузки Маркетплейс + ПЦ.',
  80
)
...
values
(
  'manual_marketplace_opp',
  'Разбор ОПП // Маркетплейс',
  '3',
  '❗️ Активные задачи',
  null,
  'Маркетплейс',
